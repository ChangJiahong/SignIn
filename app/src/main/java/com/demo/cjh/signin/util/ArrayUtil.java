...
public class ArrayUtil {
     ...
     * @param paramArrayOfByte3
     * @return
     */
    public static byte[] MergerArray(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3){

        return MergerArray(MergerArray(paramArrayOfByte1,paramArrayOfByte2),paramArrayOfByte3);
    }
